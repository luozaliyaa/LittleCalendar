...
$sourceFiles = @('MailModels.cs', 'MailStore.cs', 'MailDiagnostics.cs', 'MailClient.cs', 'MailAnalysis.cs', 'MailSync.cs', 'ChatModels.cs', 'ChatStore.cs', 'Model.cs', 'Deadlines.cs', 'CalendarVisuals.cs', 'DeadlineFields.cs', 'Agent.cs', 'Desktop.cs', 'Program.cs') | ForEach-Object { Join-Path $calendarRoot $_ }
